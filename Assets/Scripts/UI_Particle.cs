...
public class UI_Particle : MaskableGraphic
{
    ...
    protected bool Initialize()
    {
        ...
        if (_particleSystem == null)
        {
            ...
            Material material = new Material(Shader.Find("Unlit/Texture")); //UI/Particles/Hidden
            ...
            // Burası / Here / nere/ ertbaran
            //_particleSystem.main.scalingMode = ParticleSystemScalingMode.Hierarchy;
